...
class Profile(models.Model):
    ...
    street_address = models.CharField(max_length=128, default='', blank=True, null=True)
...
class VolunteerApplication(models.Model):
    ...
    street_address = models.CharField(blank=False, max_length=128, default='')
    ...
    email = models.EmailField(max_length=128, blank=False, default='')
